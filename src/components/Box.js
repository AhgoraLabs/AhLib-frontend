    ...
    return (
        <div onClick={() => window.location = `/livros/info/${bookId}`} className="h-80 w-56 m-4 mx-10 cursor-pointer border border-gray-100 rounded-3xl shadow-input-box-shadow">
            <div className='flex justify-center'>
                <div style={{ backgroundImage: `url(${!!image ? image : 'https://www.biotecdermo.com.br/wp-content/uploads/2016/10/sem-imagem-10.jpg'})` }} className="flex justify-center h-48 w-44 mt-4 bg-no-repeat bg-contain bg-center "></div>
            </div>
